...
- (void)dismiss;
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        [(UIViewController*)_viewController view].frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
    }];
}
...
- (void)clickSelf;
{
    ...
    CGFloat top = [UIScreen mainScreen].bounds.size.height-260;
